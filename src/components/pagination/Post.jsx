      ...
      { allData.map((item) => (
          <div className=" lg:w-[32%] p-[10px]">
              ...
              <Link to={`/product/${item.id}`}>
                ...
                <div className=' flex absolute top-5 left-5 opacity-[0] group-hover:top-5 duration-75 group-hover:opacity-[1] gap-x-2 text-[25px]'>
                  <FaCartShopping />
                  <FaHeart />
                  <FaSearchPlus />
                </div>
                ...
                <h2 className='group-hover:text-[#fff] text-[#fff] text-[18px] w-[110px] h-[40px] bg-black inline-block pt-2 rounded-lg '><Link to={`/product/${item.id}`}>View Shop</Link></h2>
                <div className=" w-[100%] flex justify-center items-center">
                  <div className=" text-center my-[20px]">
                    ...
                    <a className='group-hover:text-[#fff] text-[#fff] text-[18px] w-[110px] h-[40px] bg-black inline-block pt-2 rounded-lg ' >Add To Cart</a>
